...
namespace IMS.API.Controllers
{
    ...
    public class StateController : ControllerBase
    {
        ...
        public StateController(IGeographyManager manager)
        {
            _manager = manager;
        }
        ...
        {
            var list = await _manager.GetAllStatesAsync();
            return Ok(list);
        }
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(Guid id, [FromBody] StateDto dto)
        {
